...
resource "aws_subnet" "private_app_subnet_az1" {
  ...
  tags = {
    Name = "${var.vpc_name}-Private_app_subnet_az1"
  }
}
...
resource "aws_subnet" "private_app_subnet_az2" {
  ...
  tags = {
    Name = "${var.vpc_name}-private_app_subnet_az2"
  }
}
...
resource "aws_subnet" "private_data_subnet_az1" {
  ...
  tags = {
    Name = "${var.vpc_name}-private_data_subnet_az1"
  }
}
...
resource "aws_subnet" "private_data_subnet_az2" {
  ...
  tags = {
    Name = "${var.vpc_name}-Private_data_subnet_az2"
  }
}
...
# associate private data subnet az2 to "private route table"
